...
const STEPS = [
  {
    id: 1,
    title: "Book Type",
    description: "What type of book are you writing?"
  },
  {
    id: 2,
    title: "Target Audience",
    description: "Who will read this book?"
  },
  {
    id: 3,
    title: "Main Message",
    description: "What transformation should readers get?"
  },
  {
    id: 4,
    title: "Your Expertise",
    description: "What makes you qualified to write this?"
  },
  {
    id: 5,
    title: "Tone & Style",
    description: "How should your book sound?"
  }
];

export function ProjectContextWizard({
  open,
  onOpenChange,
  projectId,
  initialContext,
  onSave
}: ProjectContextWizardProps) {
  ...
  const isStepComplete = () => {
    switch (currentStep) {
      case 1:
        return formData.bookType.trim() !== "";
      case 2:
        return formData.targetAudience.trim() !== "";
      case 3:
        return formData.mainMessage.trim() !== "";
      case 4:
        return formData.uniqueQualification.trim() !== "";
      case 5:
        return formData.toneStyle.trim() !== "";
      default:
        return false;
    }
  };
        ...
        return (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500">
              This helps AI understand your book genre and structure
            </p>
          </div>
        );
        ...
        return (
          <div className="space-y-4">
            ...
            <Textarea
              ...
              placeholder="e.g., Aspiring entrepreneurs, parents of teens, marketing professionals..."
              rows={4}
            />
            <p className="text-sm text-gray-500">
              Describe who will benefit most from reading your book
            </p>
          </div>
        );
        ...
        return (
          <div className="space-y-4">
            ...
            <Textarea
              ...
              placeholder="e.g., Readers will learn how to overcome fear and build confidence..."
              rows={5}
            />
            <p className="text-sm text-gray-500">
              What should readers know, feel, or be able to do after reading?
            </p>
          </div>
        );
      ...
      case 4:
        return (
          <div className="space-y-4">
            ...
            <Textarea
              id="uniqueQualification"
              value={formData.uniqueQualification}
              onChange={(e) => setFormData({ ...formData, uniqueQualification: e.target.value })}
              placeholder="e.g., 20 years of experience, overcame similar challenges, research credentials..."
              rows={5}
            />
            <p className="text-sm text-gray-500">
              Share your expertise, experience, or unique perspective
            </p>
          </div>
        );
      ...
      case 5:
        return (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500">
              This affects how AI will help generate content in your voice
            </p>
          </div>
        );
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent onClose={() => onOpenChange(false)}>
        <DialogHeader>
          <DialogTitle>
            {isSaved ? "Context Saved!" : "Set Book Context"}
          </DialogTitle>
          <DialogDescription>
            {isSaved 
              ? "Your book context has been saved successfully."
              : "Answer these questions so AI knows how to help with your book."
            }
          </DialogDescription>
        </DialogHeader>
